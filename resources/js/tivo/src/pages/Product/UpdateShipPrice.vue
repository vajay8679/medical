        ...
        <form @submit.prevent="">
            <div class="card">
                <div class="card-body formPaddingTab" >
                    <div class="row">
                        <div v-for="data in datas" :class="data.field_type == 'text' || data.field_type == 'dropdownSelect'  || data.field_type == 'time' ||data.field_type == 'date' || data.field_type == 'number'  ? 'col-md-12 labelMargindown '   :  data.field_type == 'textarea' ? 'col-md-12 labelMargindown ' : data.field_type=='radio'||data.field_type=='checkbox'?'col-md-12 labelMargindown':''" >
...
export default {
    ...
    methods: {
        ...
        getFormData() {
            ...
            axios
                .get(`${config.apiUrl}/api/form-data?obect_type_id=4&group_id=17`, {
                    headers: {
