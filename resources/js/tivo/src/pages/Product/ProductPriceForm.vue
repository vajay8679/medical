            ...
            <div class="card-body formPaddingTab">
                <div class="row">
                    ...
                    <div v-for="data in datas" :class="data.field_type == 'text' || data.field_type == 'dropdownSelect'   || data.field_type == 'time' ||data.field_type == 'date' || data.field_type == 'number'  ? 'col-md-12 labelMargindown '   :  data.field_type == 'textarea' ? 'col-md-12 labelMargindown ' : ''">
                        ...
                        <div style="margin-top: 37px" v-if="data.field_type == 'radio'">
                            <div class="d-flex">
                                <div class="d-flex">
                                    <div>
                                        <label :for="data.input_name">{{
                                ...
                                <div v-for="(
                                    ...
                                    <div>
                                        <!-- {{item.value}} -->
                                        <input class="form-check-input myRadio" type="radio" :name="data.input_name" :id="data.input_name" :value="item.value" />
                                    </div>
                                    <div class="mx-2">
                ...
                <div>
                    <div class="col-12 save-lead d-flex justify-content-center">
                        <button v-if="EditIds == null && oneValue != 0" type="submit" class="btn btn-primary radius" @click="formSubmit()">
                            Save Quote
                        </button>

                        <button v-else-if="EditIds != null && oneValue == 0" type="submit" class="btn btn-primary radius" @click="formSubmit()">
                            Save Product Price
                        </button>
                        <button v-if="EditIds != null && oneValue != 0" type="submit" class="btn btn-primary radius" @click="formUpdate()">
...
export default {
    ...
    methods: {
        ...
        getFormData() {
            ...
            axios
                .get(`${config.apiUrl}/api/form-data?obect_type_id=4&group_id=16`, {
                    headers: {
