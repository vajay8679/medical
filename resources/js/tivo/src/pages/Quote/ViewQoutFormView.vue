<template>
    <breadCrumbs  :title="'View Form'" :main="'Quote'"/>
    <div class="container">
        ...
        <form @submit.prevent="">
            <div class="card">
                <div class="card-body">
                    <div class="uuiuiuiu">
                        <ViewLeadFormOption :leadId="lead_id"  v-if="lead_id == ''"/>
...
export default {
    ...
    methods: {
        ...
        getFormData() {
            ...
            axios
                .get(`${config.apiUrl}/api/form-data?obect_type_id=2`, {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                })
                .then((res) => {
                    console.log("pahel chal gaya");
                    ...
                    dataArray.filter((d) => {
                        if (d.field_type == "text") {
                            ...
                            console.log("deepak", this.textData);
                        }
            ...
            let promise = axios.get(`${config.apiUrl}/api/quote-form/${id}`, {
                headers: {
                    ...
                    Authorization: `Bearer ${token}`,
                         ...
                         this.lead_id = d.data.result[0].lead_id
